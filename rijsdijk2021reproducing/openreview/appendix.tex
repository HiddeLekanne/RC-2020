...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\linewidth]{IMG/scores/violin_plot_fixed.png} 
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\linewidth]{IMG/2D_perf/2D_performance_fixed_iVAE.png} 
...
\begin{figure}[!htbp]
    ...
    \begin{minipage}[b]{\textwidth}
        \centering
       \includegraphics[width=0.8\textwidth]{IMG/latent_corr/iFlow_X.png}
    \end{minipage}
    \begin{minipage}[b]{\textwidth}
    \centering
       \includegraphics[width=0.8\textwidth]{IMG/latent_corr/best_fixed_iVAE_X.png}
    \end{minipage}
