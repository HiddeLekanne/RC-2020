...
\begin{figure}[ht] 
  \begin{subfigure}[b]{0.5\linewidth}
    \centering
    \includegraphics[width=\linewidth]{IMG/scores/Mcc Score.png}
    \caption{} 
    \label{fig:MCCscores:a} 
  \end{subfigure}%% 
  \begin{subfigure}[b]{0.5\linewidth}
    \centering
    \includegraphics[width=\linewidth]{IMG/scores/Log Likelihood.png} 
    \caption{} 
...
\begin{figure}[ht] 
  ...
  \begin{subfigure}[b]{0.4\linewidth}
    \centering
    \includegraphics[width=\linewidth]{IMG/2D_perf/2D_performance_old_seed21.png} 
    \caption{} 
    \label{fig:2D:a} 
  \end{subfigure}%% 
  \begin{subfigure}[b]{0.4\linewidth}
    \centering
    \includegraphics[width=\linewidth]{IMG/2D_perf/2D_performance_old_seed42.png} 
    \caption{} 
    \label{fig:2D:b} 
  \end{subfigure} 
  \begin{subfigure}[b]{0.4\linewidth}
    \centering
    \includegraphics[width=\linewidth]{IMG/2D_perf/2D_performance_old_seed66.png} 
    \caption{} 
    \label{fig:2D:c} 
  \end{subfigure}%%
  \begin{subfigure}[b]{0.4\linewidth}
    \centering
    \includegraphics[width=\linewidth]{IMG/2D_perf/2D_performance_old_seed77.png} 
    \caption{} 
    \label{fig:2D:d} 
  \end{subfigure} 
...
\begin{figure}[!htbp]
    ...
    \begin{minipage}[b]{\textwidth}
        \centering
       \includegraphics[width=0.8\textwidth]{IMG/latent_corr/best_iFlow_42.png}
    \end{minipage}
    \begin{minipage}[b]{\textwidth}
    \centering
       \includegraphics[width=0.8\textwidth]{IMG/latent_corr/iVAE_42.png}
    \end{minipage}
...
\begin{figure}[!htbp]
    ...
    \begin{minipage}[b]{\textwidth}
        \centering
       \includegraphics[width=0.8\textwidth]{IMG/latent_corr/iFlow_92.png}
    \end{minipage}
    \begin{minipage}[b]{\textwidth}
    \centering
       \includegraphics[width=0.8\textwidth]{IMG/latent_corr/best_iVAE_92.png}
    \end{minipage}
...
\begin{figure}[htb] 
  \begin{subfigure}[b]{0.5\linewidth}
    \centering
    \includegraphics[width=\linewidth]{IMG/scores/Mcc Score_fixed.png}
    \caption{} 
    \label{fig:MCCscores_Fixed:a} 
  \end{subfigure}%% 
  \begin{subfigure}[b]{0.5\linewidth}
    \centering
    \includegraphics[width=\linewidth]{IMG/scores/Log Likelihood_fixed.png} 
    \caption{} 
